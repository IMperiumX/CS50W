...
<img src="./images/screen.jpg" with="auto">
...
<img src="./images/drag.jpg" alt="AJAX-based drag-and-drop functionality" width="45%">
...
<img src="./images/apiB.jpg" alt="educa's RESTful API"  width="auto">
...
- **init**.py: An empty file that tells Python to treat the educa directory as a Python module.
